...
class Interact:
    ...
    ##################################################
    def __init__(self, username, password, messages: messages.Messages):
        self._authenticate(username, password)
        self.subject_control = control.authenticate(username, password, users)
    ...
    def show(self):
        ...
        if not self._p_messages.show(id_, self.subject_control):
    ...
    def display(self):
        print("Messages:")
        self._p_messages.display(self.subject_control)
        print()
    ...
    def update(self):
        ...
        if not self._p_messages.show(id_, self.subject_control):
            print(f"ERROR! Message ID \'{id_}\' does not exist\n")
            return
        self._p_messages.update(id_, self._prompt_for_line("message"), self.subject_control)
        print()
    ...
    ##################################################
    def remove(self):
        self._p_messages.remove(self._prompt_for_id("delete"), self.subject_control)
